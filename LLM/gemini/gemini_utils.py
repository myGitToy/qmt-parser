...
#导入gemini模型列表
OAI_MODEL = ["api_key", "base_url", "api_type", "api_version"]
#导入google GLI服务器列表
OAI_SERVER = {
...
def config_list_from_models(
    ...
    Returns:
        ...
        list：OpenAI API调用的配置列表，每个配置都包含模型信息。
