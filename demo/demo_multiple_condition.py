...
if __name__=="__main__":
    ...
    for code in code_list:
        a = k()
        if (a.new_high_break(code =code , start = start , end = end ,  ktype = ktype , MA_HIGH_PERIOD = 100) == True) and (a.ma_positive(code =code , start = start , end = end ,  ktype = ktype ) == True):
