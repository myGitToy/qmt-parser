"""
本模块用于测试 apt.qsp_jqdata下最佳的引用例子，多条件筛选
"""
...
if __name__=="__main__":
    ...
    for code in code_list[0:10000]:
        ...
        demo.code = code
        #成交量异常模型
        df_vol = demo.money_abnormal_change(vol_ma = 20 , criteria = 2.5, N_day = 8 , count = 3 , interval = 10)[0]
        #均线多头排列模型
        df_EMA = demo.A04B02_EMA均线多头排列(ma_list=[5,20,60])[0]
