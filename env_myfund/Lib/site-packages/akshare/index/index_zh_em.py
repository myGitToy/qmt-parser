...
import os
# read EASTMONEY ut from environment so it can be overridden without editing site-packages
ut_value = os.getenv("EASTMONEY_UT", "fa5fd1943c7b386f172d6893dbfba10b")
