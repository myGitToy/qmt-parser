...
a.start_date = ak.start_date =  datetime(2025,4,20,8) #1998/10/20日开始有ETF数据    ETF日线数据和复权数据已更新完毕
...
#此数据库未删除，为老版本
sec.start_date = datetime(2025,3,20)
...
flow = money()
#此数据库未删除，为老版本
flow.start_date = datetime(2025,3,20)
