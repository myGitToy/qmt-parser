...
#全市场数据校验下次起始日期2023/10/23
a.start_date = ak.start_date =  datetime(2023,12,10,8) #1998/10/20日开始有ETF数据    ETF日线数据和复权数据已更新完毕
